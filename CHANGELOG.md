...
- Bump [go.opentelemetry.io/otel/metric](https://github.com/open-telemetry/opentelemetry-go) from 1.36.0 to 1.37.0 ([#3816](https://github.com/cosmos/gaia/pull/3816))
