...
setup-contract-tests-data:
	...
	sed -i.bak -e "s/timeout_propose = .*/timeout_propose = \"200\"/g" /tmp/contract_tests/.gaiad/config/config.toml
	...
	sed -i.bak -e "s/timeout_precommit = .*/timeout_precommit = \"200s\"/g" /tmp/contract_tests/.gaiad/config/config.toml
	sed -i.bak -e "s/timeout_precommit_delta = .*/timeout_precommit_delta = \"200\"/g" /tmp/contract_tests/.gaiad/config/config.toml
	sed -i.bak -e "s/timeout_commit = .*/timeout_commit = \"500\"/g" /tmp/contract_tests/.gaiad/config/config.toml
