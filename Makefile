...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=agaia \
		  -X github.com/cosmos/cosmos-sdk/version.AppName=agaiad \
...
draw-deps:
	...
	@goviz -i ./cmd/agaiad -d 2 | dot -Tpng -o dependency-graph.png
