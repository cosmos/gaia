...
test-docker:
	...
	@docker tag ${TEST_DOCKER_REPO}:276e9b7 ${TEST_DOCKER_REPO}:$(shell git rev-parse --abbrev-ref HEAD | sed 's#/#_#g')
	@docker tag ${TEST_DOCKER_REPO}:276e9b7 ${TEST_DOCKER_REPO}:latest
