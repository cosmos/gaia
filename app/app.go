		...
		func(ctx sdk.Context, _ upgradetypes.Plan, fromVM module.VersionMap) (module.VersionMap, error) {
			...
			hostParams := icahosttypes.Params{
				...
				AllowMessages: []string{
					...
					stakingMsgCreateValidatorResponse,
					stakingMsgEditValidator,
					stakingMsgEditValidatorResponse,
					stakingMsgDelegate,
					stakingMsgDelegateResponse,
					stakingMsgBeginRedelegate,
					stakingMsgBeginRedelegateResponse,
					stakingMsgUndelegate,
					stakingMsgUndelegateResponse,
					stakingMsgCancelUnbondingDelegation,
					stakingMsgCancelUnbondingDelegationResponse,
					stakingMsgTokenizeShares,
					stakingMsgTokenizeSharesResponse,
					stakingMsgRedeemTokensforShares,
					stakingMsgRedeemTokensforSharesResponse,
					stakingMsgTransferTokenizeShareRecord,
					stakingMsgTransferTokenizeShareRecordResponse,
					stakingMsgExemptDelegation,
					stakingMsgExemptDelegationResponse,
