...
func AppStateFn(cdc codec.JSONMarshaler, simManager *module.SimulationManager) simtypes.AppStateFn {
	return func(r *rand.Rand, accs []simtypes.Account, config simtypes.Config,
		...
		case config.GenesisFile != "":
			// override the default chain-id from gaia to set it later to the config
...
func AppStateRandomizedFn(
	...
	appParams.GetOrGenerate(
		cdc, gaiaappparams.StakePerAccount, &initialStake, r,
		func(r *rand.Rand) { initialStake = r.Int63n(1e12) },
	)
	appParams.GetOrGenerate(
		cdc, gaiaappparams.InitiallyBondedValidators, &numInitiallyBonded, r,
