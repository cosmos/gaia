...
LATEST_HEIGHT=$(curl -s https://cosmoshub.validator.network/block | jq -r .result.block.header.height);
BLOCK_HEIGHT=$(($LATEST_HEIGHT-$INTERVAL)) 
TRUST_HASH=$(curl -s "https://cosmoshub.validator.network:443/block?height=$BLOCK_HEIGHT" | jq -r .result.block_id.hash)
...
export GAIAD_STATESYNC_RPC_SERVERS="https://rpc-cosmoshub.blockapsis.com:443,https://cosmoshub.validator.network:443,https://cosmoshub-4.technofractal.com:443"
...
gaiad start --x-crisis-skip-assert-invariants --db_backend pebbledb
