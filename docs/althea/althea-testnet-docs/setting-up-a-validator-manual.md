...
RUST_LOG=INFO register-delegate-keys --validator-phrase="the phrase you saved earlier" --cosmos-grpc="http://localhost:9090" --fees=footoken
...
althea tx bank send myvalidatorkeyname <your delegate cosmos address> 5000000footoken --chain-id=althea-testnet2v1
