...
**You will generate two new keys in this step!**

**Once set these keys can not be changed!**

**If you do not save the output of these commands you will have to restart with a new validator key!**

```

gbt -a althea keys set-orchestrator-address --validator-phrase "the phrase you saved earlier" --fees=ufootoken
