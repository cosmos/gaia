...
RUST_LOG=INFO register-delegate-keys --address-prefix="althea" --validator-phrase="the phrase you saved earlier" --cosmos-grpc="http://localhost:9090" --fees=ufootoken
