...
[**Install from source**](../getting-started/installation.mdx)
...
You will find the tutorial on how to install `gaiad` [here](../getting-started/installation.mdx), and the guide to run a full-node [here](../hub-tutorials/join-mainnet.md).
