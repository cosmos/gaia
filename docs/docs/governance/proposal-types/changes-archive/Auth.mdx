...
<KeyValueTable data={currentParams.auth} />
...
- on-chain value: <Var children={currentParams.auth.max_memo_characters} />
...
- on-chain value: <Var children={currentParams.auth.tx_sig_limit} />
...
- on-chain value: <Var children={currentParams.auth.tx_size_cost_per_byte} />
...
- on-chain value: <Var children={currentParams.auth.sig_verify_cost_ed25519} />
...
- on-chain value: <Var children={currentParams.auth.sig_verify_cost_secp256k1} />
