...
- on-chain value <Var children={currentParams.mint.mint_denom} />
...
- on-chain value: <Var children={currentParams.mint.inflation_rate_change} />
...
2. the value of `inflation_rate_change`, which is <Var children={currentParams.mint.inflation_rate_change} />
...
- on-chain value: <Var children={currentParams.mint.inflation_max} />
...
- on-chain value: <Var children={currentParams.mint.inflation_min} />
...
- on-chain value: <Var children={currentParams.mint.goal_bonded} />
...
- on-chain value: <Var children={currentParams.mint.blocks_per_year} />
