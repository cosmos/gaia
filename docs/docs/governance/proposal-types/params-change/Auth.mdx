...
- on-chain value: <Var children={currentParams.auth.MaxMemoCharacters} />
...
- on-chain value: <Var children={currentParams.auth.TxSigLimit} />
...
- on-chain value: <Var children={currentParams.auth.TxSizeCostPerByte} />
...
- on-chain value: <Var children={currentParams.auth.SigVerifyCostED25519} />
...
- on-chain value: <Var children={currentParams.auth.SigVerifyCostSecp256k1} />
