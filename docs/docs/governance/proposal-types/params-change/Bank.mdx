...
- on-chain value: `SendEnabled`: <Var children={currentParams.bank.SendEnabled} />
- on-chain value: `DefaultSendEnabled`: <Var children={currentParams.bank.DefaultSendEnabled} />
