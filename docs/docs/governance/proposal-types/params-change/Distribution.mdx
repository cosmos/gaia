...
<KeyValueTable data={currentParams.distribution} />
...
- on-chain value: <Var children={currentParams.distribution.community_tax} />
...
- on-chain value: <Var children={currentParams.distribution.base_proposer_reward} />
...
- on-chain value: <Var children={currentParams.distribution.bonus_proposer_reward} />
...
- on-chain value: <Var children={currentParams.distribution.withdrawaddrenabled} />
