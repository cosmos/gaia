...
<Table data={currentParams.distribution} />
...
- on-chain value: <Var children={currentParams.distribution.communitytax} />
...
- on-chain value: <Var children={currentParams.distribution.baseproposerreward} />
...
- on-chain value: <Var children={currentParams.distribution.bonusproposerreward} />
