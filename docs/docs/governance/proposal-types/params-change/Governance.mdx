...
<KeyValueTable data={currentParams.gov} />
...
- on-chain value: <Var children={currentParams.gov.deposit_params.min_deposit} />
...
- on-chain value: <Var children={currentParams.gov.deposit_params.max_deposit_period} />
...
- on-chain value: <Var children={currentParams.gov.voting_params.voting_period} />
- `cosmoshub-4` default: `1209600000000000`
- `cosmoshub-3` default: `1209600000000000`
...
- on-chain value: <Var children={currentParams.gov.tally_params.quorum} />
...
- on-chain value: <Var children={currentParams.gov.tally_params.threshold} />
...
- on-chain value: <Var children={currentParams.gov.tally_params.veto_threshold} />
