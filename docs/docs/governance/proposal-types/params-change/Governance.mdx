...
- on-chain value: <Var children={currentParams.gov.depositparams.min_deposit} />
...
- on-chain value: <Var children={currentParams.gov.depositparams.max_deposit_period} />
...
- on-chain value: <Var children={currentParams.gov.votingparams.voting_period} />
- `cosmoshub-4` default: `1209600000000000`
- `cosmoshub-3` default: `1209600000000000`
...
- on-chain value: <Var children={currentParams.gov.tallyparams.quorum} />
...
- on-chain value: <Var children={currentParams.gov.tallyparams.threshold} />
...
- on-chain value: <Var children={currentParams.gov.tallyparams.veto_threshold} />
