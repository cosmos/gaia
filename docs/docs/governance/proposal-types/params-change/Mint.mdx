...
- on-chain value <Var children={currentParams.mint.MintDenom} />
...
- on-chain value: <Var children={currentParams.mint.InflationRateChange} />
...
1. how far away the _current staking participation ratio_ is from [`GoalBonded`](#5-GoalBonded) (67%)
2. the value of `InflationRateChange`, which is <Var children={currentParams.mint.InflationRateChange} />
...
- on-chain value: <Var children={currentParams.mint.InflationMax} />
...
- on-chain value: <Var children={currentParams.mint.InflationMin} />
...
- on-chain value: <Var children={currentParams.mint.GoalBonded} />
...
- on-chain value: <Var children={currentParams.mint.BlocksPerYear} />
