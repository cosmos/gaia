...
<Table data={currentParams.slashing} />
...
- on-chain value: <Var children={currentParams.slashing.SignedBlocksWindow} />
...
- on-chain value: <Var children={currentParams.slashing.MinSignedPerWindow} />
...
- on-chain value: <Var children={currentParams.slashing.DowntimeJailDuration} />
...
- on-chain value: <Var children={currentParams.slashing.SlashFractionDoubleSign} />
- `cosmoshub-4` default: `0.050000000000000000`
- `cosmoshub-3` default: `0.050000000000000000`
...
- on-chain value: <Var children={currentParams.slashing.SlashFractionDowntime} />
