...
* [Keplr](https://www.keplr.app/) - Android, iOS, Web
* [Leap Wallet](https://www.leapwallet.io/) - Android, iOS, Web
* [Ledger](https://www.ledger.com/cosmos-wallet) - Android, iOS, Hardware
* [Trust Wallet](https://trustwallet.com/) Android, iOS
* [Atomic Wallet](https://atomicwallet.io/) - Android, Linux, macOS, Windows
* [Cosmostation](https://www.cosmostation.io/products/cosmostation_mobile) - Android, iOS
* [Crypto.com](https://crypto.com/eea/defi-wallet) - Android, iOS
...
Metamask Snaps are plugins for the Metamask wallet that allow you to interact with the Cosmos ecosystem.

* [Leap Wallet](https://www.leapwallet.io/snaps)
* [Mystic Lab](https://metamask.mysticlabs.xyz/)

See [here](https://snaps.metamask.io/) for a full list and more information on how to use Metamask Snaps.
...
In order to run a full-node for the Cosmos Hub mainnet, you must first [install `gaiad`](/getting-started/installation.mdx). Then, follow [the guide](/hub-tutorials/join-mainnet.md).
