...
For independent live latency measurements of public no-key Cosmos Hub RPC endpoints (PublicNode, Polkachu, LavenderFive, Lava Network), see the [OpenChainBench Cosmos Hub RPC benchmark](https://openchainbench.com/benchmarks/cosmos-hub-rpc), probed every minute from three regions under a CC BY 4.0 license.
