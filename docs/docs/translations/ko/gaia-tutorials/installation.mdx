...
import { Var, PlainVar, ConsoleOutput } from '@site/src/js/Var';
...
:::tip
코스모스 SDK를 운영하기 위해서는 **<Var children={currentParams.currentRelease.golangVersion} />** 이상 버전이 필요합니다.
:::
...
<ConsoleOutput children={currentParams.currentRelease.gaidExecutionOutput} />
