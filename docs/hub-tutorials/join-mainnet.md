...
The most up to date release of Gaia is [`V6.0.3`](https://github.com/cosmos/gaia/releases/tag/v6.0.3). For those that want to use state sync or quicksync to get their node up to speed, starting with the most recent version of Gaia is sufficient.
