...
It is critically important to back-up the .gaiad/data/priv_validator_state.json file after stopping your gaiad process. This file is updated after every block you vaidator signs. It is a critical file needed to prevent double-signing, in case the upgrade fails and the previous chain needs to be restarted.
