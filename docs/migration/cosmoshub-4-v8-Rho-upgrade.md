...
This document describes the steps for validator and full node operators for the successful execution of the [v8-Rho Upgrade](../roadmap/cosmos-hub-release-log.md#v8-rho-upgrade-completed-march-15-2023), which contains the following main new features/improvement:
