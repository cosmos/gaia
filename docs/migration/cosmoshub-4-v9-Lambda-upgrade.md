...
This document describes the steps for validator and full node operators for the successful execution of the [v9-Lambda Upgrade](../roadmap/cosmos-hub-release-log.md#v9-lambda-upgrade), which contains the following main new features/improvement:
