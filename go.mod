...
require (
	...
	github.com/cosmos/tokenfactory v0.54.0
...
replace (
	...
	// In-tree forks for modules that lack v0.54-compatible upstream releases.
	// See third_party/<module>/PATCHES.md for the patch list.
	github.com/cosmos/ibc-apps/middleware/packet-forward-middleware/v11 => ./third_party/packet-forward-middleware
	github.com/cosmos/ibc-apps/modules/rate-limiting/v11 => ./third_party/rate-limiting
	github.com/cosmos/ibc-go/modules/light-clients/08-wasm/v11 => ./third_party/08-wasm
	github.com/cosmos/tokenfactory => ./third_party/tokenfactory
