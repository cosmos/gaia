...
require (
	...
	github.com/cosmos/ibc-go/v3 v3.3.1 //note to reviewer: we should inquire with @cosmosibc if this is a breaking change.
...
replace (
	...
	// use version of grpc compatible with cosmos flavored protocol buffers
