...
func TestNodeStatus(t *testing.T) {
	cleanup, _, _, port, err := InitializeRESTServer(1, []sdk.AccAddress{}, true)
...
func TestCoinSend(t *testing.T) {
	...
	require.NoError(t, err)
	cleanup, _, _, port, err := InitializeRESTServer(1, []sdk.AccAddress{addr}, true)
	require.NoError(t, err)
	defer cleanup()
...
func TestValidatorsQuery(t *testing.T) {
	cleanup, valPubKeys, operAddrs, port, err := InitializeRESTServer(1, []sdk.AccAddress{}, true)
	require.NoError(t, err)
	defer cleanup()
...
func TestBonding(t *testing.T) {
	...
	cleanup, valPubKeys, operAddrs, port, err := InitializeRESTServer(2, []sdk.AccAddress{addr}, false)
	require.NoError(t, err)
	...
	// TODO uncomment once all validators actually sign in the REST server tests
...
func TestVote(t *testing.T) {
	...
	addr, seed, err := CreateAddr(name1, pw, kb)
	require.NoError(t, err)
	cleanup, _, operAddrs, port, err := InitializeRESTServer(1, []sdk.AccAddress{addr}, true)
	require.NoError(t, err)
	defer cleanup()
...
func TestUnjail(t *testing.T) {
	...
	addr, _, err := CreateAddr(name1, pw, kb)
	require.NoError(t, err)
	cleanup, valPubKeys, _, port, err := InitializeRESTServer(1, []sdk.AccAddress{addr}, true)
	require.NoError(t, err)
	defer cleanup()
...
func TestProposalsQuery(t *testing.T) {
	...
	cleanup, _, _, port, err := InitializeRESTServer(1, []sdk.AccAddress{addrs[0], addrs[1]}, true)
	require.NoError(t, err)
	defer cleanup()
...
func TestDistributionFlow(t *testing.T) {
	...
	addr, seed, err := CreateAddr(name1, pw, kb)
	require.NoError(t, err)
	cleanup, _, valAddrs, port, err := InitializeRESTServer(1, []sdk.AccAddress{addr}, true)
	require.NoError(t, err)
	defer cleanup()
