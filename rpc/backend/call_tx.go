...
import (
	...
	//"github.com/cosmos/gaia/v23/x/evm/core/vm"
...
func (b *Backend) Resend(args evm.TransactionArgs, gasPrice *hexutil.Big, gasLimit *hexutil.Uint64) (common.Hash, error) { //todo: JSON-RPC
	//if args.Nonce == nil {
...
func (b *Backend) SetTxDefaults(args evm.TransactionArgs) (evm.TransactionArgs, error) {
...
func (b *Backend) EstimateGas(args evm.TransactionArgs, blockNrOptional *rpctypes.BlockNumber) (hexutil.Uint64, error) { //todo: JSON-RPC
...
func (b *Backend) DoCall(
	args evm.TransactionArgs, blockNr rpctypes.BlockNumber,
