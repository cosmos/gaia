...
// return nil.
func (b *Backend) BaseFee(blockRes *cmtrpctypes.ResultBlockResults) (*big.Int, error) { //todo: JSON-RPC
...
func (b *Backend) CurrentHeader() (*ethtypes.Header, error) { //todo: JSON-RPC
...
func (b *Backend) GetCoinbase() (sdk.AccAddress, error) { //todo: JSON-RPC
	...
	address, _ := sdk.AccAddressFromBech32("cosmosvaloper17mggn4znyeyg25wd7498qxl7r2jhgue8u4qjcq") // #nosec G703
	return address, nil
}
