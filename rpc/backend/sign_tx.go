...
func (b *Backend) SendTransaction(args evm.TransactionArgs) (common.Hash, error) { //todo: JSON-RPC
...
func (b *Backend) Sign(address common.Address, data hexutil.Bytes) (hexutil.Bytes, error) { //todo: JSON-RPC
...
func (b *Backend) SignTypedData(address common.Address, typedData apitypes.TypedData) (hexutil.Bytes, error) { //todo: JSON-RPC
	from := sdk.AccAddress(address.Bytes())
