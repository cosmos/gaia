...
import (
	...
	"github.com/cosmos/gaia/v23/rpc/backend"
...
type EthereumAPI interface {
	...
	SendTransaction(args evm.TransactionArgs) (common.Hash, error)
	...
	Call(args evm.TransactionArgs, blockNrOrHash rpctypes.BlockNumberOrHash, _ *rpctypes.StateOverride) (hexutil.Bytes, error)
	...
	EstimateGas(args evm.TransactionArgs, blockNrOptional *rpctypes.BlockNumber) (hexutil.Uint64, error)
	...
	FillTransaction(args evm.TransactionArgs) (*rpctypes.SignTransactionResult, error)
	Resend(ctx context.Context, args evm.TransactionArgs, gasPrice *hexutil.Big, gasLimit *hexutil.Uint64) (common.Hash, error)
...
func (e *PublicAPI) SendTransaction(args evm.TransactionArgs) (common.Hash, error) {
...
func (e *PublicAPI) Call(args evm.TransactionArgs,
	blockNrOrHash rpctypes.BlockNumberOrHash,
...
func (e *PublicAPI) EstimateGas(args evm.TransactionArgs, blockNrOptional *rpctypes.BlockNumber) (hexutil.Uint64, error) {
...
func (e *PublicAPI) FillTransaction(args evm.TransactionArgs) (*rpctypes.SignTransactionResult, error) {
