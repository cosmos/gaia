...
func queryGaiaTx(endpoint, txHash string) error { //nolint:unused // used in tests
...
func queryGaiaDenomBalance(endpoint, addr, denom string) (sdk.Coin, error) { //nolint:unused
