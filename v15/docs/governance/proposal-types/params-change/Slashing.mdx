...
<KeyValueTable data={currentParams.slashing} />
...
- on-chain value: <Var children={currentParams.slashing.signed_blocks_window} />
...
- on-chain value: <Var children={currentParams.slashing.min_signed_per_window} />
...
- on-chain value: <Var children={currentParams.slashing.downtime_jail_duration} />
...
- on-chain value: <Var children={currentParams.slashing.slash_fraction_double_sign} />
- `cosmoshub-4` default: `0.050000000000000000`
- `cosmoshub-3` default: `0.050000000000000000`
...
- on-chain value: <Var children={currentParams.slashing.slash_fraction_downtime} />
