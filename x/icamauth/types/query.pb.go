...
func init() {
	proto.RegisterType((*QueryInterchainAccountFromAddressRequest)(nil), "mauth.QueryInterchainAccountFromAddressRequest")
	proto.RegisterType((*QueryInterchainAccountFromAddressResponse)(nil), "mauth.QueryInterchainAccountFromAddressResponse")
}
...
var fileDescriptor_24f3bab05a09c04c = []byte{
	...
	,
	...
	0xce, 0x2f, 0xce, 0xcd, 0x2f, 0xd6, 0x4f, 0x4f, 0xcc, 0x4c, 0xd4, 0xaf, 0xd0, 0x87, 0xa7, 0x83,
	0x92, 0xca, 0x82, 0xd4, 0xe2, 0x24, 0x36, 0x70, 0x5c, 0x1b, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff,
	0x50, 0xe5, 0x5c, 0x20, 0x20, 0x02, 0x00, 0x00,
}
...
func (c *queryClient) InterchainAccountFromAddress(ctx context.Context, in *QueryInterchainAccountFromAddressRequest, opts ...grpc.CallOption) (*QueryInterchainAccountFromAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mauth.Query/InterchainAccountFromAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_InterchainAccountFromAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mauth.Query/InterchainAccountFromAddress",
	}
